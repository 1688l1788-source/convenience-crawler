...
def parse_cu_product(item, raw_cat_name):
    try:
        ...
        return {
            ...
            "promotion_type": promo, # 1+1, 2+1, 신상품, 일반 등 그대로 저장
            "brand_id": 1,
